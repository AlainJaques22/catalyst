 ...
 */
export const gmailSendEmailSchema: OperationSchema = {
  nodeId: 'gmail',
  nodeName: 'Gmail',
  resource: 'message',
 ...
 */
export const gmailGetEmailSchema: OperationSchema = {
  nodeId: 'gmail',
  nodeName: 'Gmail',
  resource: 'message',
  resourceName: 'Message',
 ...
 */
export const gmailReplySchema: OperationSchema = {
  nodeId: 'gmail',
  nodeName: 'Gmail',
  resource: 'message',
  resourceName: 'Message',
 ...
 */
export const gmailAddLabelSchema: OperationSchema = {
  nodeId: 'gmail',
  nodeName: 'Gmail',
  resource: 'message',
  resourceName: 'Message',
 ...
 */
export const gmailOperations: OperationSchema[] = [
 ...
 */
export function getGmailOperation(operation: string): OperationSchema | undefined {
  return gmailOperations.find(op =>
 ...
 */
export function getAllGmailOperations(): OperationSchema[] {
  return gmailOperations;
}
