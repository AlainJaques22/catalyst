...
exports.generateMultiOperationBpmnExample = generateMultiOperationBpmnExample;
 ...
 */
function generateMultiOperationBpmnExample(schema) {
    ...
    const inputParams = sampleParams.map(param => `          <camunda:inputParameter name="${param.name}">\${${param.name}}</camunda:inputParameter>`).join('\n');
    return `<?xml version="1.0" encoding="UTF-8"?>
 ...
 */
function countTotalOperations(schema) {
