...
exports.generateMultiOperationWorkflow = generateMultiOperationWorkflow;
 ...
 */
function generateMultiOperationWorkflow(schema) {
    const webhookPath = (0, naming_1.generateWebhookPath)(schema.nodeId);
